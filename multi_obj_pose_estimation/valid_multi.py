...
def valid(datacfg, cfgfile, weightfile):
    ...
    valid_dataset = dataset_multi.listDataset(valid_images, shape=(model.width, model.height), shuffle=False,
...
if __name__ == '__main__' and __package__ is None:
    ...
    parser.add_argument('--initweightfile', type=str,
                        default='backup_multi/model_backup.weights')  # initialization weights
